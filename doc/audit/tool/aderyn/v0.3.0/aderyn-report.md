...
- Found in src/TSmartAccount7702.sol [Line: 28](src/TSmartAccount7702.sol#L28)
...
- Found in src/TSmartAccount7702.sol [Line: 222](src/TSmartAccount7702.sol#L222)

	```solidity
	            || interfaceId == bytes4(0x150b7a02) // IERC721Receiver
	```

- Found in src/TSmartAccount7702.sol [Line: 240](src/TSmartAccount7702.sol#L240)
...
- Found in src/TSmartAccount7702.sol [Line: 87](src/TSmartAccount7702.sol#L87)
...
- Found in src/TSmartAccount7702.sol [Line: 55](src/TSmartAccount7702.sol#L55)
