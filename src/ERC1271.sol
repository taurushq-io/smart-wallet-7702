...
abstract contract ERC1271 {
    ...
    bytes32 private constant _MESSAGE_TYPEHASH = keccak256("SmartAccount7702Message(bytes32 hash)");
    ...
    ///         hashStruct(SmartAccount7702Message({ hash: `hash`}))
    ///      )
    ///
    /// @param hash The original hash.
    ///
    ...
    /// @notice Returns the EIP-712 typed hash of the `SmartAccount7702Message(bytes32 hash)` data structure.
    ///
    ...
    ///
    /// @param hash The `SmartAccount7702Message.hash` field to hash.
    ////
    ...
    /// @notice Returns the EIP-712 `hashStruct` result of the `SmartAccount7702Message(bytes32 hash)` data
    ///         structure.
    ///
    ...
    ///
    /// @param hash The `SmartAccount7702Message.hash` field.
    ///
